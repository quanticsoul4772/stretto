...
make test-unit       # 205 unit tests across all pure-synth modules + keys + MIDI + resume
...
| `tests/unit/test_*.c` | 205 unit tests across arena, effects, voice, gen, lsystem, chord_progression, section, density, motif, mixer, wav, keys, midi, resume |
